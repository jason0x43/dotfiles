# Generated by Powerlevel10k configuration wizard on 2020-03-09 at 08:42 EDT.
# Based on romkatv/powerlevel10k/config/p10k-lean-8colors.zsh, checksum 32742.
# Wizard options: nerdfont-complete + powerline, small icons, unicode, lean_8colors,
# time, 2 lines, disconnected, no frame, compact, few icons, concise,
