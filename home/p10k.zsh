# Generated by Powerlevel10k configuration wizard on 2019-09-23 at 09:06 EDT.
...
() {
  ...
  typeset -g POWERLEVEL9K_RULER_FOREGROUND=$BASE16_BASE14
  ...
  if [[ $POWERLEVEL9K_MULTILINE_FIRST_PROMPT_GAP_CHAR != ' ' ]]; then
    ...
    typeset -g POWERLEVEL9K_MULTILINE_FIRST_PROMPT_GAP_FOREGROUND=$BASE16_BASE05
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_{VIINS,VICMD,VIVIS}_FOREGROUND=$BASE16_BASE11
  # Red prompt symbol if the last command failed.
  typeset -g POWERLEVEL9K_PROMPT_CHAR_ERROR_{VIINS,VICMD,VIVIS}_FOREGROUND=$BASE16_BASE08
  ...
  typeset -g POWERLEVEL9K_DIR_FOREGROUND=$BASE16_BASE12
  ...
  typeset -g POWERLEVEL9K_DIR_SHORTENED_FOREGROUND=$BASE16_BASE13
  # Color of the anchor directory segments. Anchor segments are never shortened. The first
  # segment is always an anchor.
  typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND=$BASE16_BASE12
  ...
  vcs+=':-${${VCS_STATUS_LOCAL_BRANCH:0:12}//\%/%%}%4F…%5F${${VCS_STATUS_LOCAL_BRANCH: -12}//\%/%%}}}'
  # '@72f5c8a' if not on a branch.
  vcs+=':-%f@%5F${VCS_STATUS_COMMIT:0:8}}'
  # ':master' if the tracking branch name differs from local branch.
  vcs+='${${VCS_STATUS_REMOTE_BRANCH:#$VCS_STATUS_LOCAL_BRANCH}:+%f:%5F${VCS_STATUS_REMOTE_BRANCH//\%/%%}}'
  # '#tag' if on a tag.
  vcs+='${VCS_STATUS_TAG:+%f#%5F${VCS_STATUS_TAG//\%/%%}}'
  # ⇣42 if behind the remote.
  vcs+='${${VCS_STATUS_COMMITS_BEHIND:#0}:+ %5F⇣${VCS_STATUS_COMMITS_BEHIND}}'
  # ⇡42 if ahead of the remote; no leading space if also behind the remote: ⇣42⇡42.
  # If you want '⇣42 ⇡42' instead, replace '${${(M)VCS_STATUS_COMMITS_BEHIND:#0}:+ }' with ' '.
  vcs+='${${VCS_STATUS_COMMITS_AHEAD:#0}:+${${(M)VCS_STATUS_COMMITS_BEHIND:#0}:+ }%5F⇡${VCS_STATUS_COMMITS_AHEAD}}'
  # *42 if have stashes.
  vcs+='${${VCS_STATUS_STASHES:#0}:+ %5F*${VCS_STATUS_STASHES}}'
  # 'merge' if the repo is in an unusual state.
  vcs+='${VCS_STATUS_ACTION:+ %2F${VCS_STATUS_ACTION//\%/%%}}'
  # ~42 if have merge conflicts.
  vcs+='${${VCS_STATUS_NUM_CONFLICTED:#0}:+ %2F~${VCS_STATUS_NUM_CONFLICTED}}'
  ...
  # Icon color.
  typeset -g POWERLEVEL9K_VCS_VISUAL_IDENTIFIER_COLOR=$BASE16_BASE14
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_VCS_LOADING_FOREGROUND=$BASE16_BASE03
  # These settings are used for respositories other than Git or when gitstatusd fails and
  # Powerlevel10k has to fall back to using vcs_info.
  typeset -g POWERLEVEL9K_VCS_CLEAN_FOREGROUND=$BASE16_BASE15
  typeset -g POWERLEVEL9K_VCS_UNTRACKED_FOREGROUND=$BASE16_BASE15
  typeset -g POWERLEVEL9K_VCS_MODIFIED_FOREGROUND=$BASE16_BASE11
  ...
  typeset -g POWERLEVEL9K_STATUS_OK_FOREGROUND=$BASE16_BASE11
  typeset -g POWERLEVEL9K_STATUS_OK_VISUAL_IDENTIFIER_EXPANSION='✔'

  # Status when some part of a pipe command fails but the overall exit status is zero. It may look
  # like this: 1|0.
  typeset -g POWERLEVEL9K_STATUS_OK_PIPE=true
  typeset -g POWERLEVEL9K_STATUS_OK_PIPE_FOREGROUND=$BASE16_BASE11
  typeset -g POWERLEVEL9K_STATUS_OK_PIPE_VISUAL_IDENTIFIER_EXPANSION='✔'

  # Status when it's just an error code (e.g., '1'). No need to show it if prompt_char is enabled as
  # it will signify error by turning red.
  typeset -g POWERLEVEL9K_STATUS_ERROR=false
  typeset -g POWERLEVEL9K_STATUS_ERROR_FOREGROUND=$BASE16_BASE08
  typeset -g POWERLEVEL9K_STATUS_ERROR_VISUAL_IDENTIFIER_EXPANSION='↵'

  # Status when the last command was terminated by a signal.
  typeset -g POWERLEVEL9K_STATUS_ERROR_SIGNAL=true
  typeset -g POWERLEVEL9K_STATUS_ERROR_SIGNAL_FOREGROUND=$BASE16_BASE08
  ...
  typeset -g POWERLEVEL9K_STATUS_ERROR_PIPE_FOREGROUND=$BASE16_BASE08
  ...
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_FOREGROUND=$BASE16_BASE11
  ...
  typeset -g POWERLEVEL9K_BACKGROUND_JOBS_FOREGROUND=$BASE16_BASE12
  ...
  typeset -g POWERLEVEL9K_CONTEXT_FOREGROUND=$BASE16_BASE15
  # Default context format: %n is username, %m is hostname.
  typeset -g POWERLEVEL9K_CONTEXT_TEMPLATE='%n@%m'

  # Context color when running with privileges.
  typeset -g POWERLEVEL9K_CONTEXT_ROOT_FOREGROUND=$BASE16_BASE10
  ...
  ####################################[ time: current time ]####################################
  # Current time color.
  typeset -g POWERLEVEL9K_TIME_FOREGROUND=$BASE16_BASE03
