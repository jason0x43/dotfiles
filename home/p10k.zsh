# Generated by Powerlevel10k configuration wizard on 2021-01-25 at 08:52 EST.
...
() {
  ...
  #
  typeset -g POWERLEVEL9K_DIR_CLASSES=()  # don't show a folder icon in front of directory
  ...
  # Custom icon.
  typeset -g POWERLEVEL9K_VCS_VISUAL_IDENTIFIER_EXPANSION=  # don't show a github icon in front of VCS info
  # Custom prefix.
  ...
  # Custom icon.
  typeset -g POWERLEVEL9K_TIME_VISUAL_IDENTIFIER_EXPANSION=   # don't show a time icon
  # Custom prefix.
