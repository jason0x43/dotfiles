# Generated by Powerlevel10k configuration wizard on 2020-02-10 at 16:10 EST.
...
() {
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local       meta='%19F'  # grey foreground
      local      clean='%19F'  # grey foreground
      local   modified='%19F'  # grey foreground
      local  untracked='%19F'  # grey foreground
      local conflicted='%19F'  # grey foreground
    fi
  ...
  typeset -g POWERLEVEL9K_VCS_LOADING_VISUAL_IDENTIFIER_COLOR=20
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_ASDF_GO_FOREGROUND=1
  ...
  typeset -g POWERLEVEL9K_ASDF_RUST_FOREGROUND=5
  # typeset -g POWERLEVEL9K_ASDF_RUST_VISUAL_IDENTIFIER_EXPANSION='⭐'

  # .NET Core version from asdf.
  typeset -g POWERLEVEL9K_ASDF_DOTNET_CORE_FOREGROUND=6
  ...
  typeset -g POWERLEVEL9K_ASDF_LUA_FOREGROUND=3
  ...
  typeset -g POWERLEVEL9K_ASDF_ERLANG_FOREGROUND=6
