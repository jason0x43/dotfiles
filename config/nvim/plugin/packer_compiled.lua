...
_G.packer_plugins = {
  ...
  ["nvim-lspconfig"] = {
    after = { "lsp_signature.nvim", "null-ls.nvim", "nvim-lsp-ts-utils", "vim-illuminate", "trouble.nvim", "nvim-lspinstall", "lualine-lsp-progress" },
...
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'jsonc.vim', 'plenary.nvim', 'nvim-tree.lua', 'nvim-treesitter', 'nvim-lspconfig', 'vim-polyglot', 'editorconfig-vim'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
vim.cmd [[au CursorMoved * ++once lua require("packer.load")({'vim-matchup'}, { event = "CursorMoved *" }, _G.packer_plugins)]]
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'vim-fugitive', 'jsonc.vim', 'lualine.nvim', 'vim-repeat', 'plenary.nvim', 'vim-startify', 'nvim-colorizer.lua', 'vim-surround', 'nvim-tree.lua', 'nvim-web-devicons', 'telescope-fzf-native.nvim', 'FixCursorHold.nvim', 'Navigator.nvim', 'vim-commentary'}, { event = "VimEnter *" }, _G.packer_plugins)]]
