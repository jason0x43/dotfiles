...
_G.packer_plugins = {
  ...
  ["nvim-lspconfig"] = {
    after = { "null-ls.nvim", "lsp_signature.nvim", "lualine-lsp-progress", "trouble.nvim" },
    load_after = {
...
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'nvim-lspinstall', 'editorconfig-vim'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
vim.cmd [[au CursorMoved * ++once lua require("packer.load")({'vim-matchup'}, { event = "CursorMoved *" }, _G.packer_plugins)]]
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-tree.lua', 'nvim-treesitter', 'plenary.nvim', 'vim-fugitive', 'indent-blankline.nvim', 'vim-repeat', 'vim-surround', 'vim-commentary'}, { event = "BufRead *" }, _G.packer_plugins)]]
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'nvim-compe'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'nvim-web-devicons', 'Navigator.nvim', 'vim-illuminate', 'jsonc.vim', 'vim-startify', 'FixCursorHold.nvim', 'lualine.nvim', 'nvim-colorizer.lua'}, { event = "VimEnter *" }, _G.packer_plugins)]]
