...
_G.packer_plugins = {
  ...
  ["nvim-lspconfig"] = {
    after = { "lsp_signature.nvim", "lualine-lsp-progress", "trouble.nvim", "null-ls.nvim" },
    load_after = {
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'vim-commentary', 'vim-fugitive', 'vim-surround', 'nvim-tree.lua', 'nvim-treesitter', 'indent-blankline.nvim', 'vim-repeat', 'plenary.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'vim-illuminate', 'jsonc.vim', 'lualine.nvim', 'vim-startify', 'nvim-web-devicons', 'nvim-colorizer.lua', 'FixCursorHold.nvim', 'Navigator.nvim'}, { event = "VimEnter *" }, _G.packer_plugins)]]
