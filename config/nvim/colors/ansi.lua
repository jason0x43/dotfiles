...
local function get_kitty_palette()
  ...
  local is_dark = require('user.util.color').is_dark(colors.background)
...
local function apply_theme()
  ...
  hi('@markup.link.gitcommit', { fg = 'blue', underline = true })
  hi('@markup.link.label', { fg = 'blue', underline = true })
  ...
  hi('@keyword.gitcommit', {})
  hi('@label.diff', {})
  hi('@string.special.path.diff', {})
  ...
  hilink('BlinkCmpMenu', 'NONE')
  hilink('BlinkCmpMenuBorder', 'NONE')
  ...
  hilink('OpencodeInputLegend', 'Title')
