# Generated by Powerlevel10k configuration wizard on 2022-08-08 at 11:21 EDT.
...
() {
  ...
  # Foreground color of branch segment
  typeset -g POWERLEVEL9K_VCS_BRANCH_FOREGROUND=5
  ...
  #######################[ direnv: direnv status (https://direnv.net/) ]########################
  # Direnv color.
  typeset -g POWERLEVEL9K_DIRENV_FOREGROUND=9
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_ASDF_GOLANG_FOREGROUND=3
  ...
  typeset -g POWERLEVEL9K_ASDF_DOTNET_CORE_FOREGROUND=4
  # typeset -g POWERLEVEL9K_ASDF_DOTNET_CORE_VISUAL_IDENTIFIER_EXPANSION='⭐'
  # typeset -g POWERLEVEL9K_ASDF_DOTNET_CORE_SHOW_ON_UPGLOB='*.foo|*.bar'

  # Flutter version from asdf.
  typeset -g POWERLEVEL9K_ASDF_FLUTTER_FOREGROUND=5
  ...
  typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_FOREGROUND=18
  ...
  ###[ package: name@version from package.json (https://docs.npmjs.com/files/package.json) ]####
  # Package color.
  typeset -g POWERLEVEL9K_PACKAGE_FOREGROUND=3
