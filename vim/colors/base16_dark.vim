...
" Color definitions
let s:base0 = ['00', '#1c2023']
let s:base3 = ['08', '#747c84']
let s:base5 = ['07', '#c7ccd1']
let s:base7 = ['15', '#f3f4f5']
let s:base8 = ['01', '#c7ae95']
let s:baseA = ['03', '#aec795']
let s:baseB = ['02', '#95c7ae']
let s:baseC = ['06', '#95aec7']
let s:baseD = ['04', '#ae95c7']
let s:baseE = ['05', '#c795ae']
let s:base1 = ['10', '#393f45']
let s:base2 = ['11', '#565e65']
let s:base4 = ['12', '#adb3ba']
let s:base6 = ['13', '#dfe2e5']
let s:base9 = ['09', '#c7c795']
let s:baseF = ['14', '#c79595']
